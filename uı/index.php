                                    ...
                                    <div class="prog-container" data-pcid="<?php echo $array['prog_name']; ?>">
                                        <?php foreach($resultPNArray2 as $array1){  ?>
                                            <p class="list-group-item-text"> Host IP : <?php echo $array1['pc_ip']; ?> 
                                                <a href="http://localhost/zabbix/graphs.php?form=update&graphid=<?php echo $array1['cpu_id'];?>&hostid=<?php echo $array1['pc_id'];?>" ><button id="first"   class="btn btn-xs btn-info"  > CPU USAGE</button> </a>
                                                <a href="http://localhost/zabbix/graphs.php?form=update&graphid=<?php echo $array1['memory_id'];?>&hostid=<?php echo $array1['pc_id'];?>" ><button id="second"   class="btn btn-xs btn-info"  > MEMORY USAGE</button> </a>
                                                <a href="http://localhost/zabbix/graphs.php?form=update&graphid=<?php echo $array1['process_num'];?>&hostid=<?php echo $array1['pc_id'];?>" ><button id="third"   class="btn btn-xs btn-info"  > NO OF PROCESSES</button> </a>
                                            </p>
                                        <?php } ?>
                                    </div>
                                </li>
